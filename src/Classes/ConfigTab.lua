...
function ConfigTabClass:DeleteConfigSet(configSetId)
	local index = isValueInArray(self.configSetOrderList, configSetId)
	t_remove(self.configSetOrderList, index)
